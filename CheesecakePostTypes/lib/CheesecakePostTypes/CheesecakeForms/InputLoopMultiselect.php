...
class InputLoopMultiselect extends Forms
{
	...
	public function render()
	{
		...
		if($loop->have_posts()) : while($loop->have_posts()) : $loop->the_post();
			...
			$selected = $this->frontend_selected ? CheesecakePostTypes\Utils::checkForFrontendSelected('select', $key, $this->compare) : CheesecakePostTypes\Utils::checkForMultipleSelect($this->post, $this->metaName(), $key);
